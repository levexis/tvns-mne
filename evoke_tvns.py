...
if __name__ == '__main__':
    ...
    argv = sys.argv[1:]
    ALL=False
    help_mess="evoke_tvns -- -p <participant number> -c -h0.1 -l15 [--charts=n] [--topomaps] [--tmin=0] [--tmax=1] [--tint=.05] [--detrend=none/0/1"
    p_charts = False
    if (len(argv)):
        CHARTS = False
        try:
            opts, args = getopt.getopt(argv, "p:ch:l:", ["charts=","all",'tmin=','tmax=','tint=','pcharts','detrend=','topomaps'])
        except:
